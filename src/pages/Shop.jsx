...
function Shop() {
  ...
  const calculateTotalPrice = () => {
    ...
    if (petCount >= 3 && petCount < 20) {
      discount = basePrice * 0.3;  // 30% de descuento si el número de mascotas es entre 3 y 19
    } else if (petCount > 1 && petCount <= 2) {
      discount = basePrice * 0.2;  // 20% de descuento si el número de mascotas es entre 2 y 3
    }
